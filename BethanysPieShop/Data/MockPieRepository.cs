...
namespace BethanysPieShop.Data
{
    public class MockPieRepository : IPieRepository
    {
        ...
        public Pie? GetPieById(Guid pieId) => AllPies.FirstOrDefault(p => p.PieId == pieId);
